...
function setBgGreet() {
	...
	if (hour < 12) {
		//morning
		document.body.style.backgroundImage = "url('https://source.unsplash.com/1600x900/tSR133k8Diw')";
		greeting.textContent = 'Good Morning';
	} else if (hour < 18) {
		//Afternoon
		document.body.style.backgroundImage = "url('https://source.unsplash.com/SwIh3kr1__U')";
